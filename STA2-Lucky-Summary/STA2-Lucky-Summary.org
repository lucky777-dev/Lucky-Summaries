...
*** Solution (\sfrac{3}{51};\sfrac{1}{221};\sfrac{33}{221})
...
*** Solution (\sfrac{6}{35};\sfrac{18}{35};\sfrac{1}{6};\sfrac{36}{1225})
\color{luckydarkgray}
=(Voir figure 9)=
\color{black}
...
= (Réponse 1)^2 \(\textcolor{luckydarkgreen}{\mathbf{= \sfrac{36}{1225}}}\)
...
= \sfrac{1}{6} * (36+16+4+1+9+25) -- \sfrac{1}{4}
